...
function Carousel({ track }) {
  ...
  return (
    <div className="carousel" style={{ position: "relative", overflow: "hidden" }}>
      ...
      <button onClick={prevSlide} style={{ position: "absolute", top: "50%", left: "10px", zIndex: "1" }}>prev</button>
      <button onClick={nextSlide} style={{ position: "absolute", top: "50%", right: "10px", zIndex: "1" }}>Next</button>
    </div>
  );
}
